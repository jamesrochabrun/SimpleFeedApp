...
struct ItunesSearchResult<SearchResult: Decodable>: Decodable {
...
struct Artist: Decodable {
    ...
    let id: Int?
    let name: String?
//    let primaryGenre: ItuneSearchGenre? Find why <--- does not work
    
    private enum CodingKeys: String, CodingKey {
        case name = "artistName"
        case id = "artistId"
//        case primaryGenre = "primaryGenreId"
    }
}

enum ItuneSearchGenre: Int, Codable {
